const STORY_DB = [
    ...
    },
    {
        ...
        pages: [
            ...
            { text: "Kutuyu gümüş rengi boyalarla boyadı. Üzerine renkli kapaklardan düğmeler, kartondan pencereler yaptı.", image: "images/action_painting_box_space_fix.png" },
            ...
            { text: "Kokpite oturdu ve derin bir nefes aldı. Kontrol paneline (boyadığı kutuya) dokundu. 'Kule, fırlatma için izin istiyorum' dedi.", image: "images/scene_cardboard_cockpit_fix.png" },
            ...
            { text: "'10.. 9.. 8.. 7.. 6..' Her sayıda heyecanı artıyordu. Motorların ısındığını hissedebiliyordu.", image: "images/scene_space_engines_warmup_v3.png" },
            { text: "'5.. 4.. 3.. 2.. 1.. FIRLATMA!' {{heroName}} 'Vuuu!' diye bağırarak koltuğuna yapıştı.", image: "images/hero_boy_1.png" },
            { text: "Roket bahçeden havalandı. Ağaçlar aşağıda küçücük kaldı. Kuşların bile üzerine çıktı.", image: "images/scene_space_launch_garden_fix.png" },
            ...
            { text: "Yerçekimi yok olmuştu! {{heroName}} oturduğu yerden havalandığını hissetti. Bisküvisi bile havada yüzüyordu.", image: "images/action_zero_gravity_cookie_fix.png" },
            ...
            { text: "Dikkat! Karşıdan bir asteroid kuşağı geliyordu. Kaptan {{heroName}} direksiyonu sıkıca tuttu. Sağa, sola manevralar yaptı.", image: "images/scene_space_asteroid_belt_v3.png" },
            { text: "Şimdi önlerinde Satürn vardı. Halkaları buz ve taştan yapılmıştı ve gökkuşağı gibi parlıyordu.", image: "images/scene_space_saturn_v3.png" },
            ...
            { text: " Atmosfere girerken roket biraz sarsıldı ama {{heroName}} korkmadı. O tecrübeli bir pilottu.", image: "images/scene_space_turbulence_v3.png" },
        ...
        pages_en: [
            ...
            { text: "He painted the box silver. Made buttons from colorful caps, windows from cardboard.", image: "images/action_painting_box_space_fix.png" },
            ...
            { text: "Sat in cockpit, took deep breath. Touched control panel (painted box). 'Tower, requesting permission to launch.'", image: "images/scene_cardboard_cockpit_fix.png" },
            ...
            { text: "'10.. 9.. 8.. 7.. 6..' Excitement grew. Engines warming up.", image: "images/scene_space_engines_warmup_v3.png" },
            { text: "'5.. 4.. 3.. 2.. 1.. BLAST OFF!' {{heroName}} shouted 'Whoosh!' sticking to his seat.", image: "images/hero_boy_1.png" },
            { text: "Rocket lifted from garden. Trees looked tiny. Rose above birds.", image: "images/scene_space_launch_garden_fix.png" },
            ...
            { text: "Gravity gone! {{heroName}} felt floating. Even biscuit floated.", image: "images/action_zero_gravity_cookie_fix.png" },
            ...
            { text: "Attention! Asteroid belt ahead. Captain {{heroName}} held wheel tight. Maneuvered left and right.", image: "images/scene_space_asteroid_belt_v3.png" },
            { text: "Now Saturn ahead. Rings made of ice and rock shining like rainbow.", image: "images/scene_space_saturn_v3.png" },
            ...
            { text: "Rocket shook entering atmosphere but {{heroName}} wasn't scared. Experienced pilot.", image: "images/scene_space_turbulence_v3.png" },
    ...
    },
    {
        ...
        pages: [
            ...
            { text: "Hemen hayalindeki sarı denizaltısını çağırdı. Bu denizaltı çok güçlüydü ve en derinlere inebilirdi.", image: "images/scene_submarine_exterior_beach.png" },
            ...
            { text: "Denizaltı yavaşça suya battı. Önce suyun rengi açık maviydi. Güneş ışıkları suda dans ediyordu.", image: "images/scene_submarine_diving_surface.png" },
            ...
            { text: "Aniden büyük bir gölge belirdi. Bu sevimli bir deniz kaplumbağasıydı! Çok yavaş ve zarif yüzüyordu.", image: "images/scene_underwater_turtle.png" },
            { text: "Derinlere indikçe suyun rengi koyulaştı. Mavi, laciverte dönüştü. Artık güneş ışığı buraya ulaşamıyordu.", image: "images/scene_underwater_dark_descent.png" },
            ...
            { text: "Himenin yanında dev bir ahtapot uyuyordu. Ahtapot gözünü açtı ve sekiz koluyla birden esnedi. {{heroName}} kıkırdadı.", image: "images/scene_underwater_octopus_sleep.png" },
            { text: "Bir mağara girişi gördü. İçeri girmeye karar verdi. Mağaranın duvarları kristallerle kaplıydı.", image: "images/scene_underwater_crystals_cave.png" },
            ...
            { text: "Hava tanklarını kontrol etti. 'Oksijenimiz azalıyor, yukarı çıkma vakti' dedi.", image: "images/scene_submarine_cockpit_alert.png" },
            { text: "Motorları tam güce verdi. Baloncuklar çıkararak hızla yukarı yükselmeye başladılar.", image: "images/scene_submarine_surfacing_bubbles.png" },
            { text: "Su tekrar aydınlanmaya, mavileşmeye başladı. Güneşi görmek güzeldi.", image: "images/scene_underwater_light_surface.png" },
            { text: "Denizaltı 'Pop!' diye suyun yüzeyine çıktı. Martılar çığlık atarak onları karşıladı.", image: "images/scene_submarine_surface_seagulls.png" },
            { text: "Kapağı açıp temiz havayı içine çekti. Deniz hala masmavi ve sakin görünüyordu.", image: "images/hero_boy_1.png" },
            { text: "Ama {{heroName}} artık biliyordu ki, o sakin yüzeyin altında rengarenk, gizemli bir dünya vardı.", image: "images/scene_underwater_mystery_world.png" },
            { text: "Denizaltını kıyıya çekti. Ayakları kuma değdiğinde kendini gerçek bir kaşif gibi hissetti.", image: "images/scene_submarine_beach_parked.png" },
            { text: "Eve dönerken gördüğü parlayan balıkları ve dev balinayı asla unutmayacağını biliyordu.", image: "images/scene_underwater_memories_collage.png" },
            { text: "SON", image: "images/scene_the_end_card.png" }
        ],
        pages_en: [
            { text: "{{heroName}} sat on beach watching sea. 'What's at the very bottom?' he wondered.", image: "images/hero_boy_1.png" },
            { text: "Summoned imaginary yellow submarine. Very strong, could go deepest.", image: "images/scene_submarine_exterior_beach.png" },
            { text: "Opened top hatch, went in. Pressed buttons, screens on. 'Diving!'", image: "images/scene_submarine_cockpit.png" },
            { text: "Submarine sank slowly. Water light blue first. Sun danced in water.", image: "images/scene_submarine_diving_surface.png" },
            ...
            { text: "Sudden shadow. A cute sea turtle! Swimming slow and graceful.", image: "images/scene_underwater_turtle.png" },
            { text: "Water got darker deep down. Blue to navy. Sun couldn't reach here.", image: "images/scene_underwater_dark_descent.png" },
            ...
            { text: "Giant octopus sleeping next to it. Opened one eye, yawned. {{heroName}} giggled.", image: "images/scene_underwater_octopus_sleep.png" },
            { text: "Saw a cave entrance. Walls covered in crystals.", image: "images/scene_underwater_crystals_cave.png" },
            ...
            { text: "Checked air tanks. 'Oxygen low, time to go up'.", image: "images/scene_submarine_cockpit_alert.png" },
            { text: "Full power to engines. Rising fast with bubbles.", image: "images/scene_submarine_surfacing_bubbles.png" },
            { text: "Water brightening. Nice to see sun.", image: "images/scene_underwater_light_surface.png" },
            { text: "Submarine 'Pop!' surfaced. Seagulls greeted.", image: "images/scene_submarine_surface_seagulls.png" },
            { text: "Breathed fresh air. Sea looked calm.", image: "images/hero_boy_1.png" },
            { text: "But knew under surface was mysterious world.", image: "images/scene_underwater_mystery_world.png" },
            { text: "Pulled submarine to shore. Felt like real explorer.", image: "images/scene_submarine_beach_parked.png" },
            { text: "Would never forget glowing fish and giant whale.", image: "images/scene_underwater_memories_collage.png" },
            { text: "THE END", image: "images/scene_the_end_card.png" }
        ]
    },
    {
        ...
        pages: [
            ...
            { text: "Arabaya yastıklar, uyku tulumları, fenerler ve bolca yiyecek yüklediler. Bagaj tıka basa dolmuştu!", image: "images/scene_camp_car_packing.png" },
            { text: "Yolculuk başladı. Şehirden uzaklaştıkça binalar azaldı, ağaçlar çoğaldı. Camı açtığında mis gibi çam kokusu geldi.", image: "images/scene_camp_road_trip.png" },
            { text: "Ormanlık alana vardıklarında {{heroName}} {{#if pet}}ve {{heroPetName}}{{/if}} arabadan fırladı. Kuşlar cıvıl cıvıl ötüyordu. Hava serin ve tertemizdi.", image: "images/scene_camp_forest_arrival.png" },
            { text: "{{parentsActor}} 'Hadi bakalım, önce çadırımızı kuralım' dedi. Çadır kurmak dev bir yapboz yapmak gibiydi.", image: "images/scene_camp_tent_setup.png" },
            { text: "{{heroName}} {{#if sibling}}ve {{siblingName}}{{/if}} çubukları birleştirdi, kazıkları yere çaktı. Çekiç kullanmak onu çok güçlü hissettirdi.", image: "images/scene_camp_tent_stakes.png" },
            ...
            { text: "Güneş yavaş yavaş batarken ormanda bir yürüyüşe çıktılar. Kuru yaprakların üzerinde yürümek 'hışır hışır' sesler çıkarıyordu.", image: "images/scene_forest_path_sunset.png" },
            { text: "Yerde değişik ayak izleri gördü. 'Bu bir tavşan izi olmalı!' dedi {{heroName}}. Doğada bir dedektif gibi iz sürdü.", image: "images/scene_forest_footprints.png" },
            { text: "Bir ağaçkakanın 'tak tak tak' diye ağacı gagaladığını gördüler. {{#if pet}}{{heroPetName}} sesi duyunca havladı (veya miyavladı).{{/if}} Doğa ne kadar da canlıydı.", image: "images/scene_forest_woodpecker.png" },
            ...
            { text: "Gökyüzüne baktığında şaşırdı. Şehirde hiç bu kadar çok yıldız görmemişti. Sanki biri gökyüzüne sim dökmüştü.", image: "images/scene_camp_starry_sky.png" },
            { text: "{{parentsActor}} ona Büyükaıyı takımyıldızını gösterdi. Gerçekten de bir cezveye benziyordu.", image: "images/scene_camp_constellation.png" },
            ...
            { text: "Ateş köz haline gelince çadıra girdiler. Uyku tulumu sıcacıktı. Dışarıda rüzgar ağaçları sallıyordu.", image: "images/scene_camp_tent_inside_night.png" },
            { text: "{{heroName}} ormanın seslerini dinleyerek uykuya daldı. Hayatının en güzel uykularından biriydi.", image: "images/scene_camp_sleeping_bag.png" },
            { text: "Sabah kuşların neşeli şarkılarıyla uyandı. Çadırın fermuarını açtığında güneş yüzüne vurdu.", image: "images/scene_camp_morning_sun.png" },
            { text: "Çimenlerin üzerinde çiy damlaları parlıyordu. Her şey pırıl pırıldı.", image: "images/scene_forest_morning_dew.png" },
            { text: "Kahvaltıda sıcak çaylarını içtiler. {{heroName}} ormanın enerjisiyle dolmuştu.", image: "images/scene_camp_breakfast.png" },
        ...
        pages_en: [
            ...
            { text: "Loaded car with pillows, sleeping bags, flashlights, food. Trunk full!", image: "images/scene_camp_car_packing.png" },
            { text: "Journey started. Buildings fewer, trees more. Smelled pine when opened window.", image: "images/scene_camp_road_trip.png" },
            { text: "Arrived at forest. {{heroName}} {{#if pet}}and {{heroPetName}}{{/if}} jumped out. Birds chirping. Air cool and clean.", image: "images/scene_camp_forest_arrival.png" },
            { text: "{{parentsActor}} said 'Let's set up tent'. Like giant puzzle.", image: "images/scene_camp_tent_setup.png" },
            { text: "{{heroName}} {{#if sibling}}and {{siblingName}}{{/if}} joined poles, hammered stakes. Felt strong using hammer.", image: "images/scene_camp_tent_stakes.png" },
            { text: "Tent ready! Went inside. Like a secret cloth castle.", image: "images/scene_camp_tent_sunny.png" },
            { text: "Walked in forest as sun set. Dry leaves 'crunch crunch'.", image: "images/scene_forest_path_sunset.png" },
            { text: "Saw strange footprints. 'Must be rabbit!' said {{heroName}}. Tracked like detective.", image: "images/scene_forest_footprints.png" },
            { text: "Saw woodpecker 'tap tap tap'. {{#if pet}}{{heroPetName}} barked (or meowed) at noise.{{/if}} Nature so alive.", image: "images/scene_forest_woodpecker.png" },
            ...
            { text: "Looked at sky. Never seen so many stars in city. Like glitter spilled.", image: "images/scene_camp_starry_sky.png" },
            { text: "{{parentsActor}} showed Big Dipper. Looked like coffee pot.", image: "images/scene_camp_constellation.png" },
            ...
            { text: "Fire turned to embers, went into tent. Sleeping bag warm. Wind shook trees outside.", image: "images/scene_camp_tent_inside_night.png" },
            { text: "{{heroName}} fell asleep listening to forest. Best sleep ever.", image: "images/scene_camp_sleeping_bag.png" },
            { text: "Woke up to bird songs. Sun hit face when opened zipper.", image: "images/scene_camp_morning_sun.png" },
            { text: "Dew drops on grass. Everything sparkling.", image: "images/scene_forest_morning_dew.png" },
            { text: "Drank hot tea. Filled with forest energy.", image: "images/scene_camp_breakfast.png" },
    ...
    },
    {
        ...
        pages: [
            ...
            { text: "{{parentsActor}} 'Hadi bavulunu hazırla' dediğinde en sevdiği şortlarını, kova küreğini ve güneş gözlüğünü hemen seçti.", image: "images/scene_holiday_packing.png" },
            { text: "Bavulun fermuarı zor kapandı ama başardı! Arabayı hazırlarken o da arka koltuğa yerleşti.", image: "images/scene_holiday_car_trunk.png" },
            { text: "Yolculuk uzundu ama eğlenceliydi. Radyoda çalan şarkılara eşlik ettiler. Camdan koyunları, dağları saydı.", image: "images/scene_holiday_road_trip.png" },
            { text: "Sonunda ufukta mavi bir çizgi göründü. Deniz! {{heroName}} 'Deniiiiz!' diye bağırdı sevinçle.", image: "images/scene_holiday_sea_view.png" },
            { text: "Otele vardıklarında odaları mis gibi lavanta kokuyordu. Ama {{heroName}}'in aklı fikri aşağıdaydı.", image: "images/scene_holiday_hotel_room.png" },
            { text: "Hızla mayosunu giydi, güneş kremini sürdü (bunu pek sevmiyordu ama mecburdu!) ve plaja koştu.", image: "images/scene_holiday_getting_ready.png" },
            ...
            { text: "Sudan çıkınca kova ve küreğini aldı. 'Dünyanın en büyük kalesini yapacağım' dedi.", image: "images/scene_beach_bucket_shovel.png" },
            ...
            { text: "Kalenin duvarlarını bulduğu renkli deniz kabuklarıyla süsledi. Tepesine de bir martı tüyü dikti. Bayrak gibi dalgalandı.", image: "images/scene_beach_castle_decorated.png" },
            { text: "Yanına bir yengeç yaklaştı. Yengeç kaleye şaşkın şaşkın baktı, sonra yan yan yürüyerek uzaklaştı.", image: "images/scene_beach_crab.png" },
            { text: "Acıkınca sahildeki büfeden mısır aldılar. Tuzlu suyun ardından haşlanmış mısır ne kadar da lezzetliydi!", image: "images/scene_beach_corn.png" },
            { text: "Öğleden sonra {{parentsActor}} ile suda top oynadılar. {{heroName}} topa öyle bir vurdu ki top taa açıklara gitti.", image: "images/scene_beach_ball_play.png" },
            ...
            { text: "Akşam yemeğinden sonra çarşıyı gezdiler. Her yer ışıl ışıldı ve dondurma kokuyordu.", image: "images/scene_holiday_night_market.png" },
            { text: "En sevdiği dondurmacıda durdular. {{heroName}} kocaman bir külah dondurma aldı. Tadı harikaydı!", image: "images/scene_holiday_ice_cream.png" },
            { text: "Otele dönerken çok yorulmuştu. Gözleri kapanıyordu. Deniz havası onu çarpmıştı.", image: "images/scene_holiday_tired_walk.png" },
            { text: "Yatağına yattığında hala dalgaların sesini duyabiliyordu. 'Hışşşt... Hışşşt...' diye ninniler söylüyordu deniz.", image: "images/scene_holiday_bed_night.png" },
            { text: "Yarın yine yüzecek, yine kale yapacaktı. Tatil daha yeni başlıyordu.", image: "images/hero_boy_1.png" },
            { text: "Rüyasında yunuslarla yarıştığını, denizaltı krallığına gittiğini gördü.", image: "images/scene_dream_dolphins.png" },
            { text: "SON", image: "images/scene_the_end_card.png" }
        ],
        pages_en: [
            { text: "{{heroName}} was so excited for summer holiday to start!", image: "images/hero_boy_1.png" },
            { text: "{{parentsActor}} said 'Pack your bag'. Picked favorite shorts, bucket and sunglasses.", image: "images/scene_holiday_packing.png" },
            { text: "Zipper barely closed but did it! Jumped to back seat of car.", image: "images/scene_holiday_car_trunk.png" },
            { text: "Long but fun journey. Sang along radio. Counted sheep outside.", image: "images/scene_holiday_road_trip.png" },
            { text: "Finally saw blue line. Sea! {{heroName}} shouted 'Seaaaa!'", image: "images/scene_holiday_sea_view.png" },
            { text: "Hotel room smelled like lavender. But mind was downstairs.", image: "images/scene_holiday_hotel_room.png" },
            { text: "Put on swim suit and sunscreen (didn't like it but had to). Ran to beach.", image: "images/scene_holiday_getting_ready.png" },
            ...
            { text: "Got bucket and shovel. 'Will build biggest castle ever'.", image: "images/scene_beach_bucket_shovel.png" },
            ...
            { text: "Decorated walls with shells. Put seagull feather on top as flag.", image: "images/scene_beach_castle_decorated.png" },
            { text: "Crab approached. Looked at castle confused, walked away sideways.", image: "images/scene_beach_crab.png" },
            { text: "Ate boiled corn. Tasted great after salty water!", image: "images/scene_beach_corn.png" },
            { text: "Played ball in water with {{parentsActor}}. Hit so hard it went far.", image: "images/scene_beach_ball_play.png" },
            ...
            { text: "Walked in bazaar after dinner. Lights everywhere, smelled like ice cream.", image: "images/scene_holiday_night_market.png" },
            { text: "Stopped at favorite ice cream shop. Bought huge cone. Yummy!", image: "images/scene_holiday_ice_cream.png" },
            { text: "Very tired going back to hotel. Sea air made sleepy.", image: "images/scene_holiday_tired_walk.png" },
            { text: "Heard waves from bed. 'Shhh... Shhh...' Sea singing lullaby.", image: "images/scene_holiday_bed_night.png" },
            { text: "Swim again tomorrow, build castle again. Holiday just started.", image: "images/hero_boy_1.png" },
            { text: "Dreamed racing dolphins, going to underwater kingdom.", image: "images/scene_dream_dolphins.png" },
            { text: "THE END", image: "images/scene_the_end_card.png" }
        ]
    },
    {
        ...
        pages: [
            ...
            { text: "Havalimanına gittiklerinde gözlerine inanamadı. Burası kocaman bir yerdi, insanlar arılar gibi oradan oraya koşuşturuyordu.", image: "images/scene_airport_terminal.png" },
            { text: "Önce güvenlikten geçtiler. Çantasını yürüyen banda koydu, makinenin içinden geçişini izledi. Çok ilginçti!", image: "images/scene_airport_security.png" },
            ...
            { text: "Anons yapıldı: 'Sayın yolcularımız, uçağımız kalkışa hazırdır.' Kalbi küt küt attı.", image: "images/scene_airport_gate.png" },
            { text: "Uçağın kapısından girerken hostes abla ona gülümsedi. 'Hoş geldin küçük gezgin' dedi.", image: "images/scene_plane_boarding.png" },
            { text: "Koridorda ilerleyip koltuğunu buldu. Yaşasın! Pencere kenarıydı. Hemen oturdu ve dışarı baktı.", image: "images/scene_plane_seat.png" },
            { text: "'Klik' sesiyle kemerini bağladı. Pilot konuşmaya başladı: 'Kaptanınız konuşuyor, uçuş süremiz 2 saat.'", image: "images/scene_plane_safety.png" },
            { text: "Motorlardan 'VUUUU' diye güçlü bir ses geldi. Uçak pistte ilerlemeye başladı. Hızlandı, hızlandı...", image: "images/scene_plane_takeoff_run.png" },
            { text: "Ve birden koltuğa yapıştı! Tekerlekler yerden kesildi. Havalanıyorlardı! {{heroName}} şaşkınlıkla güldü.", image: "images/scene_plane_takeoff_air.png" },
            { text: "Aşağıdaki arabalar oyuncak gibi, evler kibrit kutusu gibi görünüyordu. Yollar incecik ipler gibiydi.", image: "images/scene_plane_view_cars.png" },
            { text: "Şehir uzaklaştı, tarlalar, nehirler harita gibi altına serildi. Dünya yukarıdan çok farklı görünüyordu.", image: "images/scene_plane_view_map.png" },
            ...
            { text: "Hostesler yemek servisine başladı. Uçakta sandviç yemek çok havalıydı. Meyve suyunu yudumladı.", image: "images/scene_plane_meal.png" },
            { text: "Tuvalete gitmek istedi. Uçak tuvaleti çok küçüktü ve 'voşş' diye gürültülü çalışıyordu. Biraz korktu ama komikti.", image: "images/scene_plane_toilet.png" },
            { text: "Pilot 'İnişe geçiyoruz' dediğinde uçak hafifçe sallandı. Bu türbülanstı, sanki araba tümsekte zıplamış gibi.", image: "images/scene_plane_turbulence.png" },
            { text: "Tekrar bulutların altına indiler. Şehir ışıkları görünmeye başladı. Akşam olmuştu.", image: "images/scene_plane_landing_lights.png" },
            { text: "Tekerlekler piste 'GÜM' diye değdi. Uçak yavaşladı. Yolcular alkışladı. {{heroName}} de alkışladı.", image: "images/scene_plane_runway.png" },
            { text: "Uçaktan inerken pilota el salladı. 'Büyüyünce ben de pilot olacağım' dedi.", image: "images/scene_plane_cockpit.png" },
            { text: "Havalimanından çıkarken başını kaldırıp gökyüzüne baktı. Az önce oradaydı. Bu inanılmazdı.", image: "images/scene_airport_exit.png" },
            { text: "Bavulunu sürüklerken kendini çok önemli bir iş adamı gibi hissetti.", image: "images/scene_airport_luggage.png" },
        ...
        pages_en: [
            ...
            { text: "Airport was huge. People running like bees.", image: "images/scene_airport_terminal.png" },
            { text: "Passed security. Bag went through machine. Interesting!", image: "images/scene_airport_security.png" },
            ...
            { text: "Announcement: 'Plane ready for boarding'. Heart pounded.", image: "images/scene_airport_gate.png" },
            { text: "Hostess smiled at door. 'Welcome little traveler'.", image: "images/scene_plane_boarding.png" },
            { text: "Found seat. Yes! Window seat. Sat and looked out.", image: "images/scene_plane_seat.png" },
            { text: "Fastened seatbelt 'Click'. Captain spoke: 'Flight time 2 hours'.", image: "images/scene_plane_safety.png" },
            { text: "Engines roared 'VUUUU'. Plane moved on runway. Faster, faster...", image: "images/scene_plane_takeoff_run.png" },
            { text: "Glued to seat! Wheels off ground. Flying! Laughed with amazement.", image: "images/scene_plane_takeoff_air.png" },
            { text: "Cars like toys below, houses like matchboxes. Roads like thin strings.", image: "images/scene_plane_view_cars.png" },
            { text: "City faded. Fields, rivers like map below. World looked different.", image: "images/scene_plane_view_map.png" },
            ...
            { text: "Meal service started. Eating sandwich on plane cool. Sipped juice.", image: "images/scene_plane_meal.png" },
            { text: "Went to toilet. Tiny and loud 'whoosh'. Scared but funny.", image: "images/scene_plane_toilet.png" },
            { text: "Pilot said 'Landing'. Plane shook slightly. Turbulence.", image: "images/scene_plane_turbulence.png" },
            { text: "Went under clouds. City lights appeared. Evening time.", image: "images/scene_plane_landing_lights.png" },
            { text: "Wheels hit runway 'BUMP'. Plane slowed. Passengers applauded.", image: "images/scene_plane_runway.png" },
            { text: "Waved at pilot leaving. 'Will be pilot when I grow up'.", image: "images/scene_plane_cockpit.png" },
            { text: "Looked at sky leaving airport. Was just there. Amazing.", image: "images/scene_airport_exit.png" },
            { text: "Felt like important businessman dragging luggage.", image: "images/scene_airport_luggage.png" },
    ...
    },
    {
        ...
        pages: [
            ...
            { text: "İstasyon çok kalabalıktı. Düdük sesleri, tekerlek gıcırtıları, koşturan insanlar... Büyük bir karmaşa ama çok heyecanlı!", image: "images/scene_train_station_crowd.png" },
            ...
            { text: "Bilet kontrol memuru biletlerini deldi. 'İyi yolculuklar küçük yolcu' dedi ve şapkasını düzeltti.", image: "images/scene_train_conductor.png" },
            ...
            { text: "Dışarıdan bir düdük sesi geldi: 'DÜÜÜT!'. Tren sarsılarak hareket etti. Tekerlekler dönmeye başladı.", image: "images/scene_train_departing.png" },
            { text: "Önce yavaş yavaş hızlandılar. İstasyon geride kaldı. Şehir binaları bir bir geçti.", image: "images/scene_train_city_exit.png" },
            { text: "Tekerlekler raylarda 'tak-taka-tak, tak-taka-tak' diye ritmik bir ses çıkarıyordu. Bu ses {{heroName}}'in hoşuna gitti.", image: "images/scene_train_wheels.png" },
            ...
            { text: "Aniden her yer karardı! Bir tünele girmişlerdi. {{heroName}} heyecanla 'Aaa!' dedi. Pencerede sadece kendi yansımasını gördü.", image: "images/scene_train_tunnel.png" },
            { text: "Bir dakika sonra ışık tekrar geldi. Gözleri kamaştı. Şimdi dağların arasından geçiyorlardı.", image: "images/scene_train_mountains.png" },
            { text: "{{parentsActor}} 'Hadi yemekli vagona gidelim' dedi. Tren sallandığı için koridorda yürümek çok zordu.", image: "images/scene_train_corridor.png" },
            { text: "Sağa sola çarparak, penguen gibi yürüyerek yemekli vagona ulaştılar. Gülmekten karınları ağrıdı.", image: "images/scene_train_walking_funny.png" },
            ...
            { text: "Tren bir köprünün üzerinden geçti. Aşağıda gümüş gibi parlayan bir nehir akıyordu.", image: "images/scene_train_bridge.png" },
            { text: "Yanlarından başka bir tren hızla geçti. 'Vınnn!' diye rüzgarı vagonlarını salladı.", image: "images/scene_train_passing.png" },
            { text: "Yolculuk boyunca kitap okudu, resim çizdi, bulmaca çözdü. Zamanın nasıl geçtiğini anlamadı.", image: "images/scene_train_activity.png" },
            { text: "Akşam olurken kondüktör 'Son durak!' diye bağırdı. Tren yavaşlamaya başladı.", image: "images/scene_train_sunset.png" },
            { text: "Frenler 'ciiiyk' diye öttü ve tren durdu. İnmeye hazırlandılar.", image: "images/scene_train_stopping.png" },
            { text: "Trenden inerken bacakları biraz uyuşmuştu ama mutluydu. Rayların şarkısını hala duyabiliyordu.", image: "images/scene_train_platform.png" },
            { text: "Trendeki o sallantıyı, o sesleri ve manzaraları çok sevmişti.", image: "images/hero_boy_1.png" },
            { text: "İstasyondan çıkarken arkasına dönüp trene baktı. 'Teşekkürler koca tren' dedi.", image: "images/scene_train_goodbye.png" },
            { text: "{{mentorName}} onları karşılamaya gelmişti. Koşup ona sarıldı.", image: "images/hero_boy_1.png" },
            { text: "Bu tren yolculuğu, tatilin en güzel başlangıcı olmuştu.", image: "images/scene_holiday_start.png" },
            { text: "SON", image: "images/scene_the_end_card.png" }
        ],
        pages_en: [
            { text: "Smelled iron and steam entering station. Smelled like history.", image: "images/hero_boy_1.png" },
            { text: "Station crowded. Whistles, wheels, running people... Chaotic but exciting!", image: "images/scene_train_station_crowd.png" },
            { text: "Saw giant train resting on rails. Like iron snake. Locomotive looked strong.", image: "images/scene_train_station.png" },
            { text: "Conductor punched tickets. 'Have a safe trip little passenger'.", image: "images/scene_train_conductor.png" },
            { text: "Found seats. Confortable and huge window.", image: "images/scene_train_compartment.png" },
            { text: "Heard whistle 'Choo choo!'. Train moved shaking. Wheels turned.", image: "images/scene_train_departing.png" },
            { text: "Accelerated slowly. Station behind. City passed by.", image: "images/scene_train_city_exit.png" },
            { text: "Wheels made rhythmic sound 'clack-clack'. Loved this sound.", image: "images/scene_train_wheels.png" },
            { text: "City ended, fields started. Cows gazing. Tractors working.", image: "images/scene_train_landscape.png" },
            { text: "Suddenly dark! Tunnel. Excitedly shouted 'Aaa!'. Saw reflection.", image: "images/scene_train_tunnel.png" },
            { text: "Light came back. Blinded. Passing mountains now.", image: "images/scene_train_mountains.png" },
            { text: "{{parentsActor}} said 'Let's go to dining car'. Walking hard while shaking.", image: "images/scene_train_corridor.png" },
            { text: "Walked like penguin bumping sides. Laughed hard.", image: "images/scene_train_walking_funny.png" },
            { text: "Ate toast drank juice. Eating with view fun.", image: "images/scene_train_dining_car.png" },
            { text: "Passed over bridge. Silver river below.", image: "images/scene_train_bridge.png" },
            { text: "Another train passed 'Vroom!'. Wind shook car.", image: "images/scene_train_passing.png" },
            { text: "Read book, drew pictures. Time flew.", image: "images/scene_train_activity.png" },
            { text: "Conductor shouted 'Last stop!'. Train slowed.", image: "images/scene_train_sunset.png" },
            { text: "Brakes squeaked. Stopped. Ready to leave.", image: "images/scene_train_stopping.png" },
            { text: "Legs numb but happy. Could still hear rail song.", image: "images/scene_train_platform.png" },
            { text: "Loved Shakespeare, sounds and views.", image: "images/hero_boy_1.png" },
            { text: "Looked back at train. 'Thanks big train'.", image: "images/scene_train_goodbye.png" },
            { text: "{{mentorName}} met them. Hugged {{mentorName}}.", image: "images/hero_boy_1.png" },
            { text: "Best start to holiday.", image: "images/scene_holiday_start.png" },
            { text: "THE END", image: "images/scene_the_end_card.png" }
        ]
    },
    {
